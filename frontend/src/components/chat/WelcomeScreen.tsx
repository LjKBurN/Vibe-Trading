...
const CHIP_KEYS = [
  ...
  "welcome.chipTools",
  "welcome.chipMarkets",
  "welcome.chipConnectors",
  "welcome.chipTimeframes",
  "welcome.chipOptimizers",
  "welcome.chipRisk",
  "welcome.chipOptions",
  "welcome.chipPdf",
  "welcome.chipFactor",
