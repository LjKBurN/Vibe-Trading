    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2 text-xs text-muted-foreground uppercase tracking-wide">
          <Layers className="h-3.5 w-3.5" aria-hidden="true" /> {t("alpha.zoo")}
        </div>
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
          {t("alpha.browseTitle", { count: total > 0 ? total : 452 })}
        </h1>
      ...
      <section className="space-y-2">
        ...
        <div className="border rounded-xl overflow-hidden">
          <table className="w-full text-sm">
            <tbody>
              <MetaRow label={t("alpha.metaTheme")} value={metaString(meta, "theme")} />
              <MetaRow label={t("alpha.metaUniverse")} value={metaString(meta, "universe")} />
              <MetaRow label={t("alpha.metaFrequency")} value={metaString(meta, "frequency")} />
              <MetaRow label={t("alpha.metaDecayHorizon")} value={metaString(meta, "decay_horizon")} />
              <MetaRow label={t("alpha.metaMinWarmup")} value={metaString(meta, "min_warmup_bars")} />
              <MetaRow label={t("alpha.metaRequiresSector")} value={metaString(meta, "requires_sector")} />
              <MetaRow label={t("alpha.metaModulePath")} value={a.module_path || "—"} />
              <MetaRow label={t("alpha.metaNotes")} value={metaString(meta, "notes")} last />
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section className="space-y-2">
        ...
        <details className="border rounded-xl bg-card group">
          <summary className="cursor-pointer px-4 py-3 text-sm font-medium hover:bg-muted/40 select-none">
            {t("alpha.viewSource", { lines: (detail.source_code || "").split("\n").length })}
          </summary>
...
function BenchView() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2 text-xs text-muted-foreground uppercase tracking-wide">
          <Play className="h-3.5 w-3.5" aria-hidden="true" /> {t("alpha.benchRunner")}
        </div>
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
          {t("alpha.benchTitle")}
        </h1>
...
function ResultPanel({ result }: { result: AlphaBenchResult }) {
  ...
  useEffect(() => {
    ...
    chart.setOption({
      ...
      legend: {
        data: [t("alpha.alive"), t("alpha.reversed"), t("alpha.dead")],
      ...
      series: [
        { name: t("alpha.alive"), type: "bar", stack: "n", data: aliveSeries, itemStyle: { color: theme.upColor } },
        { name: t("alpha.reversed"), type: "bar", stack: "n", data: reversedSeries, itemStyle: { color: theme.warningColor } },
        { name: t("alpha.dead"), type: "bar", stack: "n", data: deadSeries, itemStyle: { color: theme.downColor } },
      ],
    });
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <TopTable title={t("alpha.top5ByIr")} rows={result.top5_by_ir || []} />
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b">
              ...
              <th className="text-right px-4 py-2 text-xs text-muted-foreground font-medium">{t("alpha.ir")}</th>
