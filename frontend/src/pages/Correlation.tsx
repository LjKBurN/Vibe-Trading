...
export function Correlation() {
  ...
  const compute = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : t("correlation.failedCompute"));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex flex-col gap-4 border rounded-lg p-4">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            placeholder={t("correlation.assetCodesPlaceholder")}
        ...
        >
          {loading ? t("correlation.computing") : t("correlation.compute")}
        </button>
      </div>
